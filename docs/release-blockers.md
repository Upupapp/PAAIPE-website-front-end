...
- **B-8** — Hosting owner, release method, rollback and incident contacts unnamed. Unblocks the Tab 16 operations gate. Needed before any release: who owns the hosting account, how a release is published atomically, how it is rolled back, and who is contacted when it breaks
